...
- **X / Twitter Embed Support for Rebits**: Upgraded X/Twitter Rebits to use responsive native card styling with verified author avatar, handle, exact timestamp, formatted tweet text, and direct X actions.
...
- **Inline Composer Expansions & Anchored Popovers**: Replaced separate modal dialogs for Media, Link/Rebit, Schedule, and Mood in the composer with streamlined inline expansions, direct native uploads, and anchored popover menus across desktop and mobile.
  - **Inline Link / Rebit Bar**: Clicking the Link toolbar icon toggles an inline URL input bar directly beneath the composer textarea with instant OpenGraph card fetching and expandable inline metadata editing fields (title, description, custom preview image).
  ...
  - **Schedule Popover**: Replaced the schedule modal with an anchored popover featuring one-click time presets (*Tomorrow 9:00 AM*, *Tomorrow 6:00 PM*, *In 2 Days*), custom datetime selection, and Set/Clear actions.
